<div class="books index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('contains'); ?></th>
			<th><?php echo $this->Paginator->sort('image_path'); ?></th>
			<th><?php echo $this->Paginator->sort('url_amazon'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($book['Book']['contains']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['image_path']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['url_amazon']); ?>&nbsp;</td>
		<td class="actions">
